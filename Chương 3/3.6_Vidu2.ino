int buttonPin = A2; // khởi tạo biến buttonPin trên bo mạch
int ledPin = 10;  // khởi tạo biến ledPin
int buttonState = LOW; // khởi tạo biến buttonState
void setup() {
	pinMode(ledPin, OUTPUT); // thiết lập chế độ cho chân ledPin là xuất dữ liệu
pinMode(buttonPin, INPUT); // thiết lập chế độ cho chân buttonPin là nhập dữ liệu
}
void loop(){
